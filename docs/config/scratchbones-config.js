window.SCRATCHBONES_CONFIG = {
  ...
  game: {
    ...
    "dyes": {
      ...
      "legacyDyeMigrations": {
        "dye:CLOTH:red": "dye:CLOTH:deep_red",
        "dye:CLOTH:orange": "dye:CLOTH:deep_orange",
        "dye:CLOTH:yellow": "dye:CLOTH:bright_yellow",
        "dye:CLOTH:green": "dye:CLOTH:deep_green",
        "dye:CLOTH:blue": "dye:CLOTH:deep_blue",
        "dye:CLOTH:purple": "dye:CLOTH:pure_violet",
