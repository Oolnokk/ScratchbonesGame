...
export function normalizeScratchbonesGameConfig(rawGameConfig = {}) {
  ...
  return {
    ...
    trickBones: {
      ...
      summaryDisplay: {
        glyphSizePx: Math.max(8, Number(rawGameConfig.trickBones?.summaryDisplay?.glyphSizePx) || 28),
        ...
        seatColor: String(rawGameConfig.trickBones?.summaryDisplay?.seatColor || 'var(--text)'),
        ...
        glyphFilter: String(rawGameConfig.trickBones?.summaryDisplay?.glyphFilter || 'drop-shadow(0 1px 2px rgba(0,0,0,0.55))'),
        ...
        multiplyGlyphFilter: String(rawGameConfig.trickBones?.summaryDisplay?.multiplyGlyphFilter || 'invert(1) drop-shadow(0 1px 2px rgba(0,0,0,0.55))'),
      },
      definitions: trickBoneDefinitions,
