...
function normalizeChatConfig(value) {
  ...
  return {
    ...
    messageFxSpawnAfterZoomResetMs: normalizeFiniteNumber(source.messageFxSpawnAfterZoomResetMs ?? source.bubbleSpawnAfterZoomResetMs, DEFAULT_CHAT_CONFIG.messageFxSpawnAfterZoomResetMs, { min: 0 }),
