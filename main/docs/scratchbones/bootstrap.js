 ...
 // Used by: debug panel rendering and state dumps.
   ...
   function mulberry32(a) {
    ...
    function applyLayoutContract(app) {
      ...
      const handCardContainerWidthOffsetPx = clampNumber(Number(layoutSizing.handCardContainerWidthOffsetPx) || 4, 0, 24);
      const handCardLabelInsetLeftPx = clampNumber(Number(layoutSizing.handCardLabelInsetLeftPx) || 2, 0, 24);
      const handCardLabelInsetBottomPx = clampNumber(Number(layoutSizing.handCardLabelInsetBottomPx) || 2, 0, 24);
